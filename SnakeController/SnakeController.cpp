...
Segments::Segment Controller::calculateNewHead() const
{
    Segments::Segment const& currentHead = m_segments.front();

    Segments::Segment newHead;
...
void Controller::addHeadSegment(Segments::Segment const& newHead)
{
...
void Controller::removeTailSegmentIfNotScored(Segments::Segment const& newHead)
{
...
void Controller::updateSegmentsIfSuccessfullMove(Segments::Segment const& newHead)
{
